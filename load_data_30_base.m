...
if b_edit_switch ~= 0
    b_scale_switch = input('Enter 0 if you do NOT want to scale the branch parameters, but edit parameters directly.\n');
    if b_scale_switch ~=0
        scale_factor = input('Enter the number you wish to scale the parameters, do not enter negative values or 0, and only enter real numbers.\n');
    else 
        prompt1 = 'Enter r: ';
        prompt2 = 'Enter x: ';
        prompt3 = 'Enter b: ';
...
option_switch = input('Enter 1 if you want to enforce reactive power limits.\n');
...
if b_edit_switch ~= 0
    if b_scale_switch ~= 0
%branch data set for scaling up/down
%branch resistance data
    %below is branches between grid and home
    mpc.branch(1, BR_R) = scale_factor*0.00281;
    mpc.branch(2, BR_R) = scale_factor*0.00297;
    mpc.branch(3, BR_R) = scale_factor*0.00342;
    mpc.branch(4, BR_R) = scale_factor*0.00330;
    mpc.branch(5, BR_R) = scale_factor*0.00299;
    mpc.branch(6, BR_R) = scale_factor*0.00330;
    mpc.branch(7, BR_R) = scale_factor*0.00785;
    mpc.branch(8, BR_R) = scale_factor*0.00452;
    mpc.branch(9, BR_R) = scale_factor*0.00410;
    mpc.branch(10, BR_R) = scale_factor*0.00562;
    mpc.branch(11, BR_R) = scale_factor*0.00281;
    mpc.branch(12, BR_R) = scale_factor*0.00297;
    mpc.branch(13, BR_R) = scale_factor*0.00342;
    mpc.branch(14, BR_R) = scale_factor*0.00330;
    mpc.branch(15, BR_R) = scale_factor*0.00299;
    mpc.branch(16, BR_R) = scale_factor*0.00330;
    mpc.branch(17, BR_R) = scale_factor*0.00785;
    mpc.branch(18, BR_R) = scale_factor*0.00452;
    mpc.branch(19, BR_R) = scale_factor*0.00410;
    mpc.branch(20, BR_R) = scale_factor*0.00562;
    mpc.branch(21, BR_R) = scale_factor*0.00281;
    mpc.branch(22, BR_R) = scale_factor*0.00297;
    mpc.branch(23, BR_R) = scale_factor*0.00342;
    mpc.branch(24, BR_R) = scale_factor*0.00330;
    mpc.branch(25, BR_R) = scale_factor*0.00299;
    mpc.branch(26, BR_R) = scale_factor*0.00330;
    mpc.branch(27, BR_R) = scale_factor*0.00785;
    mpc.branch(28, BR_R) = scale_factor*0.00452;
...
%     mpc.branch(43, BR_R) = scale_factor*0.00025;
%     mpc.branch(44, BR_R) = scale_factor*0.00123;
%     mpc.branch(45, BR_R) = scale_factor*0.00052;
%     mpc.branch(46, BR_R) = scale_factor*0.00047;
%     mpc.branch(47, BR_R) = scale_factor*0.00058;
%     mpc.branch(48, BR_R) = scale_factor*0.00120;
%     mpc.branch(49, BR_R) = scale_factor*0.00120;
%     mpc.branch(50, BR_R) = scale_factor*0.00102;
%     mpc.branch(51, BR_R) = scale_factor*0.00058;
%     mpc.branch(52, BR_R) = scale_factor*0.00025;
%     mpc.branch(53, BR_R) = scale_factor*0.00123;
%     mpc.branch(54, BR_R) = scale_factor*0.00052;
%     mpc.branch(55, BR_R) = scale_factor*0.00047;
...
%branch reactance data    
    %below is branches between grid and home
    mpc.branch(1, BR_X) = scale_factor*0.0281;
    mpc.branch(2, BR_X) = scale_factor*0.0297;
    mpc.branch(3, BR_X) = scale_factor*0.0342;
    mpc.branch(4, BR_X) = scale_factor*0.0285;
    mpc.branch(5, BR_X) = scale_factor*0.0245;
    mpc.branch(6, BR_X) = scale_factor*0.0300;
    mpc.branch(7, BR_X) = scale_factor*0.0452;
    mpc.branch(8, BR_X) = scale_factor*0.0741;
    mpc.branch(9, BR_X) = scale_factor*0.0470;
    mpc.branch(10, BR_X) = scale_factor*0.0561;
    mpc.branch(11, BR_X) = scale_factor*0.0281;
    mpc.branch(12, BR_X) = scale_factor*0.0297;
    mpc.branch(13, BR_X) = scale_factor*0.0342;
    mpc.branch(14, BR_X) = scale_factor*0.0285;
    mpc.branch(15, BR_X) = scale_factor*0.0245;
    mpc.branch(16, BR_X) = scale_factor*0.0300;
    mpc.branch(17, BR_X) = scale_factor*0.0452;
    mpc.branch(18, BR_X) = scale_factor*0.0741;
    mpc.branch(19, BR_X) = scale_factor*0.0470;
    mpc.branch(20, BR_X) = scale_factor*0.0561;
    mpc.branch(21, BR_X) = scale_factor*0.0281;
    mpc.branch(22, BR_X) = scale_factor*0.0297;
    mpc.branch(23, BR_X) = scale_factor*0.0342;
    mpc.branch(24, BR_X) = scale_factor*0.0285;
    mpc.branch(25, BR_X) = scale_factor*0.0245;
    mpc.branch(26, BR_X) = scale_factor*0.0300;
    mpc.branch(27, BR_X) = scale_factor*0.0452;
    mpc.branch(28, BR_X) = scale_factor*0.0741;
...
%     mpc.branch(43, BR_X) = scale_factor*0.0421;
%     mpc.branch(44, BR_X) = scale_factor*0.0980;
%     mpc.branch(45, BR_X) = scale_factor*0.0432;
%     mpc.branch(46, BR_X) = scale_factor*0.0703;
%     mpc.branch(47, BR_X) = scale_factor*0.0889;
%     mpc.branch(48, BR_X) = scale_factor*0.0120;
%     mpc.branch(49, BR_X) = scale_factor*0.0120;
%     mpc.branch(50, BR_X) = scale_factor*0.0102;
%     mpc.branch(51, BR_X) = scale_factor*0.0058;
%     mpc.branch(52, BR_X) = scale_factor*0.0421;
%     mpc.branch(53, BR_X) = scale_factor*0.0980;
%     mpc.branch(54, BR_X) = scale_factor*0.0432;
%     mpc.branch(55, BR_X) = scale_factor*0.0703;
...
%branch susceptace data    
    %below is branches between grid and home
    mpc.branch(1, BR_B) = scale_factor*0.00712;
    mpc.branch(2, BR_B) = scale_factor*0.00674;
    mpc.branch(3, BR_B) = scale_factor*0.00875;
    mpc.branch(4, BR_B) = scale_factor*0.00952;
    mpc.branch(5, BR_B) = scale_factor*0.00685;
    mpc.branch(6, BR_B) = scale_factor*0.00725;
    mpc.branch(7, BR_B) = scale_factor*0.00486;
    mpc.branch(8, BR_B) = scale_factor*0.00985;
    mpc.branch(9, BR_B) = scale_factor*0.00743;
    mpc.branch(10, BR_B) = scale_factor*0.00886;
    mpc.branch(11, BR_B) = scale_factor*0.00712;
    mpc.branch(12, BR_B) = scale_factor*0.00674;
    mpc.branch(13, BR_B) = scale_factor*0.00875;
    mpc.branch(14, BR_B) = scale_factor*0.00952;
    mpc.branch(15, BR_B) = scale_factor*0.00685;
    mpc.branch(16, BR_B) = scale_factor*0.00725;
    mpc.branch(17, BR_B) = scale_factor*0.00486;
    mpc.branch(18, BR_B) = scale_factor*0.00985;
    mpc.branch(19, BR_B) = scale_factor*0.00743;
    mpc.branch(20, BR_B) = scale_factor*0.00886;
    mpc.branch(21, BR_B) = scale_factor*0.00712;
    mpc.branch(22, BR_B) = scale_factor*0.00674;
    mpc.branch(23, BR_B) = scale_factor*0.00875;
    mpc.branch(24, BR_B) = scale_factor*0.00952;
    mpc.branch(25, BR_B) = scale_factor*0.00685;
    mpc.branch(26, BR_B) = scale_factor*0.00725;
    mpc.branch(27, BR_B) = scale_factor*0.00486;
    mpc.branch(28, BR_B) = scale_factor*0.00985;
...
%     mpc.branch(43, BR_B) = scale_factor*0.00356;
%     mpc.branch(44, BR_B) = scale_factor*0.00778;
%     mpc.branch(45, BR_B) = scale_factor*0.00875;
%     mpc.branch(46, BR_B) = scale_factor*0.04123;
%     mpc.branch(47, BR_B) = scale_factor*0.05582;
%     mpc.branch(48, BR_B) = scale_factor*0.01026;
%     mpc.branch(49, BR_B) = scale_factor*0.01026;
%     mpc.branch(50, BR_B) = scale_factor*0.04123;
%     mpc.branch(51, BR_B) = scale_factor*0.07582;
%     mpc.branch(52, BR_B) = scale_factor*0.00356;
%     mpc.branch(53, BR_B) = scale_factor*0.00778;
%     mpc.branch(54, BR_B) = scale_factor*0.00875;
%     mpc.branch(55, BR_B) = scale_factor*0.04123;
